...
const { Flag } = await import("@localcode/core/flag/flag")
const { Plugin } = await import("../../src/plugin/index")
const { Workspace } = await import("../../src/control-plane/workspace")
const { Instance } = await import("../../src/project/instance")

const experimental = Flag.LOCALCODE_EXPERIMENTAL_WORKSPACES
...
afterAll(() => {
  ...
  Flag.LOCALCODE_EXPERIMENTAL_WORKSPACES = experimental
})
