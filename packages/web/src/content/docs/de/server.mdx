...
Der Benutzername ist standardmaessig `opencode`, kann aber mit `LOCALCODE_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `opencode serve` und `opencode web`.
