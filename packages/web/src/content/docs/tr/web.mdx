...
```bash
LOCALCODE_SERVER_PASSWORD=secret opencode web
```

Kullanıcı adı varsayılan olarak `opencode` şeklindedir ancak `LOCALCODE_SERVER_USERNAME` ile değiştirilebilir.
